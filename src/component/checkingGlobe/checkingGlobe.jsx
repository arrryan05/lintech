...
const CheckingGlobe = () => {
  return (
    <div className=" relative flex md:h-full h-[300px] w-full max-w-[548px] items-center justify-center overflow-hidden rounded-lg  bg-background px-40   md:pb-60 md:shadow-xl">
